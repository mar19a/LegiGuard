...
const JoinNow = () => {
  return (
    <section className="py-20 text-center bg-gradient-to-r from-emerald-600 via-emerald-500 to-emerald-600 text-white rounded-3xl mx-auto shadow-lg">
      ...
      <button
        className="bg-white text-emerald-700 px-8 py-4 rounded-full font-semibold text-base shadow-md transition transform hover:scale-105 hover:shadow-lg cursor-pointer"
      >
        Join the Newsletter
      </button>
    </section>
