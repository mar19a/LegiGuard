...
const iconMap = {
  ...
  "Automated Evidence": FileText, 
  "Vendor Risk Manager": AlertTriangle,
  "Real-Time Dashboard": ShieldCheck,
  "Training Module": BookOpenCheck,
};
...
const FEATURES = [
  ...
  },
  {
    ...
    description: "Collect and organize compliance evidence without manual uploads.",
    bullets: ["Continuous sync", "Audit-ready folders", "Role-based access"],
    href: "/features/automated-evidence",
    category: "Automation",
    tags: ["SOC2", "ISO27001", "HIPAA"],
    kpi: "Live",
  },
  {
    title: "Vendor Risk Manager",
    description: "Assess and track third-party vendor compliance status.",
    bullets: ["Vendor scoring", "Contract checks", "Remediation tracking"],
    href: "/features/vendor-risk-manager",
    category: "Monitoring",
    tags: ["GDPR", "SOC2"],
    kpi: "Beta",
  },
  {
    ...
    description: "Visualize compliance KPIs with live audit status updates.",
    bullets: ["Custom widgets", "Live alerts", "Exportable charts"],
    href: "/features/real-time-dashboard",
    category: "Reporting",
    tags: ["SOC2", "ISO27001", "GDPR"],
    kpi: "New",
  },
  {
    title: "Training Module",
    description: "Interactive security and compliance training for your team.",
    bullets: ["Role-based courses", "Quizzes", "Completion tracking"],
    href: "/features/training-module",
    category: "Knowledge",
